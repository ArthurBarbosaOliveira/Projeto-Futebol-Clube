...
<strong>👨‍💻 O que foi desenvolvido </strong>
  ...
  No time de desenvolvimento do `PFC`, onde eu _Arthur Barbosa_ com meu *squad* ficou responsável por desenvolver uma API (utilizando o método `TDD`) e também integrar *- através do docker-compose -* as aplicações para que elas funcionem consumindo um banco de dados.
